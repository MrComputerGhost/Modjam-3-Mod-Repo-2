package mrcomputerghost.forbiddenlands.entities;
...
public class EntityWarlock extends EntityWitch implements IRangedAttackMob {
    ...
    public EntityWarlock(World par1World)
    {
        super(par1World);
