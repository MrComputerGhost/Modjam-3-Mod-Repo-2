...
public class BlockParadoxFire extends BlockFire {
     ...
     */
    public void onBlockAdded(EntityPlayer player, World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        if (par1World.provider.dimensionId == 0) {
        	...
        	par1World.playSound((double)((float)par2 + 0.5F), (double)((float)par3 + 0.5F), (double)((float)par4 + 0.5F), "mob.horse.zombie.death", 1.0F + par5Random.nextFloat(), par5Random.nextFloat() * 0.7F + 0.3F, false);
    ...
    public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        if (!par1World.doesBlockHaveSolidTopSurface(par2, par3 - 1, par4) && !((BlockParadoxFire) ForbiddenBlocks.ParadoxFire).canBlockCatchFire(par1World, par2, par3 - 1, par4, UP))
        {
            if (((BlockParadoxFire) ForbiddenBlocks.ParadoxFire).canBlockCatchFire(par1World, par2 - 1, par3, par4, EAST))
            {
                for (l = 0; l < 2; ++l)
                {
            ...
            if (((BlockParadoxFire) ForbiddenBlocks.ParadoxFire).canBlockCatchFire(par1World, par2 + 1, par3, par4, WEST))
            {
                for (l = 0; l < 2; ++l)
                {
            ...
            if (((BlockParadoxFire) ForbiddenBlocks.ParadoxFire).canBlockCatchFire(par1World, par2, par3, par4 - 1, SOUTH))
            {
                for (l = 0; l < 2; ++l)
                {
                    ...
                    par1World.spawnParticle("death_suspend", (double)f, (double)f1, (double)f2, 0.0D, 0.0D, 0.0D);
                }
            }

            if (((BlockParadoxFire) ForbiddenBlocks.ParadoxFire).canBlockCatchFire(par1World, par2, par3, par4 + 1, NORTH))
            {
                for (l = 0; l < 2; ++l)
                {
                    f = (float)par2 + par5Random.nextFloat();
            ...
            if (((BlockParadoxFire) ForbiddenBlocks.ParadoxFire).canBlockCatchFire(par1World, par2, par3 + 1, par4, DOWN))
            {
                for (l = 0; l < 2; ++l)
                {
                    f = (float)par2 + par5Random.nextFloat();
        ...
        else
        {
            for (l = 0; l < 3; ++l)
            {
                ...
                f2 = (float)par4 + par5Random.nextFloat();
                par1World.spawnParticle("footsteps", (double)f, (double)f1, (double)f2, 0.0D, 0.0D, 0.0D);
            }
        }
    }
    ...
    public void onEntityCollidedWithBlock(World world, int par2, int par3, int par4, Entity entity, EntityPlayer player) {
